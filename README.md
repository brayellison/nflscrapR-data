...
For installation and setup of PostgreSQL, there's excellent [instructions](https://github.com/BurntSushi/nfldb/wiki/Installation) on how to do it on the original [`nfldb` wiki](https://github.com/BurntSushi/nfldb). The instruction are for Arch, but there's an [Ubuntu installation](Installation-on-Ubuntu) guide as well.
